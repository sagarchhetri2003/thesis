...
app.title = "Liverpool Full Dashboard"

app.layout = dbc.Container(fluid=True, children=[
    dbc.Row([
        dbc.Col(html.H2("⚽ Liverpool Dashboard (ALL REAL PLOTS)", className="text-center text-primary my-4"), width=12)
    ]),
    dbc.Tabs([
        dbc.Tab(label="🏠 Home vs Away", tab_id="home-away"),
        dbc.Tab(label="📈 Match Timeline", tab_id="timeline"),
        dbc.Tab(label="🎯 xG & Goals", tab_id="xg"),
    ], id="tabs", active_tab="home-away", className="mb-3"),
