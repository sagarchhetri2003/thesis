...
fig5.update_traces(marker_line_color='white', marker_line_width=1.5, textposition='outside')
...
fig10 = fig = px.bar(team_xg_diff, x='Home', y='xG_diff',
...
fig531.update_traces(textposition='top center', marker=dict(size=10, color='red'))
fig531.update_layout(
    title_font=dict(size=22),
    margin=dict(l=60, r=60, t=80, b=60),
    xaxis_tickformat='%Y',
...
fig532.update_traces(textposition='top center')
fig532.update_layout(
    title_font=dict(size=22),
    margin=dict(l=60, r=60, t=80, b=60),
...
app.title = "Liverpool Dashboard - Cleaned"

app.layout = dbc.Container(fluid=True, children=[
    dbc.Row([
        dbc.Col(html.H2("⚽ Liverpool Dashboard with All Real Plots", className="text-center text-primary my-4"), width=12)
    ]),
    dbc.Tabs([
        dbc.Tab(label="📊 All Real Visuals", tab_id="all"),
